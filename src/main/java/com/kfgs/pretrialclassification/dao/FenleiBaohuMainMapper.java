...
public interface FenleiBaohuMainMapper extends BaseMapper<FenleiBaohuMain> {
    ...
    IPage<FenleiBaohuMainResultExt> selectByCondition(IPage<FenleiBaohuMainResultExt> page, @Param("id") String id,@Param("name") String name,@Param("sqr") String sqr,@Param("sqh") String sqh,@Param("state") String state,@Param("begintime") String begintime,@Param("endtime") String endtime);
