...
public class CaseConditionQueryServiceImpl implements CaseConditionQueryService {
    ...
    @Transactional
    //查询所有案件
    public IPage findAll(String pageNo, String limit,String id,String name,String oraginization,String sqr,String sqh,String worker,String state,String begintime,String endtime,String enterBeginTime,String enterEndTime) {
        Map resultMap = new HashMap();
        Page<FenleiBaohuMainResultExt> page = new Page<>(Long.parseLong(pageNo),Long.parseLong(limit));
        IPage<FenleiBaohuMainResultExt> iPage = fenleiBaohuMainMapper.selectByCondition(page,id,name,oraginization,sqr,sqh,worker,state,begintime,endtime,enterBeginTime, enterEndTime);
        return iPage;
    }
