    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        if (completeToken != null && completeToken.startsWith(this.jwtTokenUtils.getTokenHead())) {
            ...
            if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                FenleiBaohuUserinfoExt userDetails = userService.validateUsername(username);
                //FenleiBaohuUserinfoExt userDetails = fenleiBaohuUserinfoService.validateUsername(username);
